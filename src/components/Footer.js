...
function Footer() {
	return (
		<footer className="border mt-12 border-t border-gray-200 bg-gray-50  py-6 md:py-10 px-4 sm:px-6 lg:px-12 text-md leading-6">
			<div className="max-w-container mx-auto font-bold text-center space-y-4 md:space-y-0 md:flex md:justify-center">
				...
				<h1 className="mt-2">
					...
					<a
						...
						class="font-medium text-gray-900 hover:text-gray-500 transition-colors duration-150"
					>
